      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-orange-100 px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-sm font-medium text-orange-600">100% Natural • Salud en Cada Gota</span>
            <span className="h-2 w-2 rounded-full bg-orange-500"></span>
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900 mb-6">
            Jugos naturales de <span className="text-orange-600">calidad premium</span>
          </h1>
          <p className="max-w-2xl mx-auto text-lg text-gray-600">
            Descubre el sabor auténtico de la naturaleza en cada botella, elaborados con los mejores ingredientes frescos.
          </p>
        </div>
                ...
                <div className="relative h-full">
                  <div className="p-6 sm:p-8">
                    <div className="inline-flex items-center gap-2 bg-orange-100 px-3 py-1 rounded-full mb-3">
                      <Icon icon="lucide:star" className="text-orange-600 h-4 w-4" />
              ...
              <CardBody className="p-0 overflow-hidden">
                <div className="p-6 sm:p-8">
                  <div className="inline-flex items-center gap-2 bg-green-100 px-3 py-1 rounded-full mb-3">
                    <Icon icon="lucide:briefcase" className="text-green-600 h-4 w-4" />
                    <span className="text-xs font-medium text-green-600">Oportunidad de Negocio</span>
                  </div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
              ...
              <CardBody className="p-0 overflow-hidden">
                <div className="p-6 sm:p-8">
                  <div className="inline-flex items-center gap-2 bg-blue-100 px-3 py-1 rounded-full mb-3">
                    <Icon icon="lucide:users" className="text-blue-600 h-4 w-4" />
                    <span className="text-xs font-medium text-blue-600">Únete a Nosotros</span>
                  </div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
              ...
              <div className="grid md:grid-cols-2 h-full">
                <div className="p-8 sm:p-10 flex flex-col justify-center">
                  <div className="inline-flex items-center gap-2 bg-purple-100 px-3 py-1 rounded-full mb-3 w-fit">
                    <Icon icon="lucide:heart" className="text-purple-600 h-4 w-4" />
                    <span className="text-xs font-medium text-purple-600">Nuestra Filosofía</span>
                  </div>
                  <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
                    Nuestra pasión por la <span className="text-orange-600">calidad</span>
                  </h3>
                  <p className="text-gray-600 mb-6 text-lg">
                    EXCELENCIA, CALIDAD, DEDICACIÓN, EXPERIENCIA Y EL MEJOR SERVICIO
                    AL CLIENTE son los valores que nos definen y nos impulsan cada día.
                  </p>
                  <p className="text-gray-600 mb-8">
                    Desde la selección de las mejores frutas hasta el proceso de embotellado, 
                    cada paso está diseñado para garantizar que nuestros jugos conserven todo 
